...
<div class="form">
	...
	<table style="margin-left: auto; margin-right: auto;">
		...
		<tr>
			<th colspan="4" height="30">내용</th>
		</tr>
		<tr>
			<td colspan="4" height="auto" valign="top"><br>${content.boardContent}<br></td>
		</tr>
		<tr>
	...
	<c:if test="${sessionScope.userId == content.userId}">
		...
		<input type="button" value="삭제" id="btn" onclick="deleteContent();">
	</c:if>
...
<script>		
		function deleteContent(){
			alert("게시물이 삭제되었습니다!");
			location.href='${pageContext.request.contextPath}/deleteProcess.do?boardNo=${content.boardNo}';
		}
</script>
</body>
</html>
